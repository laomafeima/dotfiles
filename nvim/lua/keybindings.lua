...
vim.api.nvim_set_keymap('', '<tab>n', ':tabnew<cr>', opts)
vim.api.nvim_set_keymap('', '<tab>w', ':tabclose<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>1', ':tabn 1<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>2', ':tabn 2<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>3', ':tabn 3<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>4', ':tabn 4<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>5', ':tabn 5<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>6', ':tabn 6<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>7', ':tabn 7<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>8', ':tabn 8<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>9', ':tabn 9<cr>', opts)
vim.api.nvim_set_keymap('', '<leader>0', ':tabn 10<cr>', opts)
vim.api.nvim_set_keymap('', '<s-tab>', ':tabnext<CR>', opts)
vim.api.nvim_set_keymap('i', '<s-tab>', '<ESC>:tabnext<CR>', opts)
