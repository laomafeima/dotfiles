...
Plug 'autozimu/LanguageClient-neovim', {
            \ 'branch': 'next',
            \ 'do': 'bash install.sh && pip3 install python-language-server && pip3 install neovim && rustup component add rls-preview rust-analysis rust-src && cargo install racer',
            \ }
